// ===== DATA =====
      ...
      body.innerHTML = `
        <div class="notif-guest">
          ...
          <div class="auth-provider-list">
            <button class="auth-btn google" onclick="closeNotifModal(); openReloginScreen();">
  ...
  // Tampilkan halaman login bergaya branded (kolase foto). Dipakai sebagai
  // gerbang SEBELUM redirect ke Google di semua titik login: jalan pintas
  // di samping bar kategori, modal profil, modal notifikasi, dan alur
  // relogin setelah "Keluar". Selalu bisa dilewati lewat tombol X atau
  ...
  async function logoutUser() {
    ...
    filterAndRender();
    // Tampilkan lagi layar kolase login setelah keluar
    openReloginScreen();
  }
